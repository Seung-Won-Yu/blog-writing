...
class IntegrationPageTests(unittest.TestCase):
    ...
    def test_renders_one_step_image_and_adfit_html_assembler(self):
        ...
        self.assertIn("반드시 티스토리가 만든 <code>[##_Image|..._##]</code> 태그를 사용하세요.", page)
        ...
        self.assertIn("function extractTistoryImageMarkup(value)", page)
        self.assertIn("function hasExpiringTistoryImageUrl(value)", page)
        self.assertIn("hasExpiringTistoryImageUrl(value)", page)
        self.assertIn("blog\\.kakaocdn\\.net", page)
        self.assertIn("tistoryImagePattern", page)
        ...
        self.assertIn("tistoryImageCount", page)
