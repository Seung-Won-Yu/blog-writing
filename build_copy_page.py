  ...
  <div class="wrap">
    <header>
      <div class="header-row">
        ...
        <a class="action-btn" href="{esc(WORKFLOW_URL)}" target="_blank" rel="noopener" title="GitHub Actions에서 Run workflow를 누르면 오늘 초안을 생성하고 복사 페이지 배포까지 요청합니다.">초안 수동 생성/배포</a>
      </div>
    </header>
