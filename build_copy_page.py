...
<body>
      ...
      <main class="panel">
        ...
        <div class="content" id="content">
          ...
          <section class="review-card" aria-labelledby="reviewTitle">
            <h2 id="reviewTitle">발행 전 내 내용 더하기 · 선택</h2>
            <p>품질 검사를 통과한 초안은 바로 복사할 수 있습니다. 직접 확인한 사실이나 내 관점을 더하고 싶을 때만 아래 칸을 사용하세요.</p>
            <div class="review-grid">
              <label class="review-field" for="verificationNote">직접 확인한 내용 · 선택
                <textarea id="verificationNote" maxlength="800" placeholder="원문에서 직접 대조한 수치, 적용 범위, 제한 조건을 구체적으로 적어주세요."></textarea>
              </label>
              <label class="review-field" for="editorNote">내 판단·경험 · 선택
  ...
  ${{relatedHtml}}
    ...
    function updateReviewState() {{
      ...
      if (currentBaseHtml) {{
        els.htmlCode.value = buildReviewedHtml();
      }}
      updatePreviewNote();
    }}
