...
글감은 `검색 지속성 30 · 실제 문제 해결성 30 · 재현 가능성 20 · 시각 설명 가능성 10 · 기존 글 연결성 10`으로 비교합니다. 최근 90일 자동화글과 핵심 질문이나 결론이 겹치면 다른 주제를 고릅니다. 뉴스 요약을 두 번째로 만들지 않습니다.
