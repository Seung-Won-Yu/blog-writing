...
5. 핵심 사실마다 공개 웹에서 직접 확인 가능한 자료를 둡니다. 참고 자료 3~6개에 공식 문서·표준·기관 자료 1개 이상과 독립 설명·원 논문·교육 자료 1개 이상을 포함합니다. 역사적 주장에는 당시 문서나 신뢰할 수 있는 기록을 우선하고, 수치에는 조건·단위·범위를 함께 씁니다. 확인하지 못한 유래·최초·세계 1위·절대적인 안전성은 쓰지 않습니다. 근거가 부족하면 `NO_PUBLISH_EVIDENCE`, 품질이 부족하면 `NO_PUBLISH_QUALITY`로 종료하며 원고·이미지·커밋·푸시를 만들지 않습니다.
