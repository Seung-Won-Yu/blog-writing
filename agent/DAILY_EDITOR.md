...
3. 다음 기준으로 핵심뉴스 1건을 고릅니다.
   ...
   최근 3일의 제목·태그·원문 호스트를 함께 보고 같은 핵심 브랜드·발행처는 기본적으로 제외합니다. 기술 주제가 달라도 목록에서 같은 회사 글로 먼저 읽히면 반복으로 판단합니다. 긴급 보안·서비스 장애처럼 독자가 당일 해야 할 행동이 달라진 경우에만 예외로 선택할 수 있습니다. 예외라면 반복 브랜드를 제목에서 제외하고 WordPress·패치 대상·영향받는 사용자처럼 새 핵심 대상을 앞세웁니다. 대표 이미지는 새 핵심 대상과 달라진 행동을 보여 주며 반복 회사 로고나 같은 제품 구도를 중심에 두지 않습니다.
